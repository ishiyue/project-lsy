...
public class DateUtil {
    ...
    public static String getDate(String formatter) {
        return getDate(new Date(), formatter);
    }
    ...
    public static String getDate(Date date, String formatter) {
        ...
        return localDateTime.format(java.time.format.DateTimeFormatter.ofPattern(formatter));
    }
    /**
     ...
     * @return
     */
    public static Date parseToDate(String date, String formatter) {
